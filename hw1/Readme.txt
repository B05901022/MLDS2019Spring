...
1、執行 python3 hw1-1_function.py (-type="deep") (-func="0")可執行模型訓練並產生結果(-type可接受"shallow","medium","deep")(-function可接受"0","1")
...
2、執行 python3 hw1-2_task1_plot.py 可將weight取PCA後繪圖(reproduce所需之資料存放於All_Weight.zip中，將檔案解壓縮至python檔所在資料夾後即可執行)
...
1-2(task2)
1、執行 python3 hw1-2_task2-1.py，可得到loss、function和gradient norm的圖
2、執行 pytohn3 hw1-2_task2-2.py，可得到accuracy、loss和gradient norm的圖
