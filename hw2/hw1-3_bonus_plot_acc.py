...
plot_1 = sns.pointplot("batch_size", "train_acc", data = results_plot, color='blue', logx=True)

plot_2 = sns.pointplot("batch_size", "test_acc", data = results_plot, color='blue', logx=True, linestyles='--')
