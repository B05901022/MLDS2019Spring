# -*- coding: utf-8 -*-
"""
Created on Mon Apr 29 16:39:14 2019

@author: Austin Hsu
"""

FLAGS = {
    "t2t_usr_dir": "hw2-2_t2t",  # Tensor2tensor imports from this dir.
    "data_dir": "E:/MLDS_dataset/hw2-2/data/FilmDialog/no_stop_words",
    "train_dir": "E:MLDS_dataset/hw2-2/train/FilmDialog/seq2seq_base-base_with_numbers",
    "decode_dir": "E:/MLDS_dataset/hw2-2/decode/FilmDiaplog/trf_20_dropout-base",
    "problem": "Chatbot",
    "model": "transformer",
    ...
    "save_every_n_secs": 60,  # Every n seconds, overrides hour param.
    "evaluation_steps": 10,   # Number of evaluation steps at each cycle.
    "evaluation_freq": 10,    # Evaluation cycle is run every n train steps.

    # Decoding related flags.
    "batch_size": 32,
    "output_file_name": "inference.txt",  # Save the inference outputs.
    "input_file_name": "clr_conversation.txt",  # Read inputs to be fed.
...
DATA_FILTERING = {
    "data_dir": "E:/MLDS_dataset/hw2-2/data/FilmDialog/no_stop_words/filtered_data/avg_word_embedding",
