...
class Generator(nn.Module):
    def __init__(self):
        ...
        self.convt3=nn.Sequential(nn.BatchNorm2d(32,momentum=0.9),
                                  nn.ConvTranspose2d(32,3,4,2,1),
                                  nn.ReLU()
                                  )
        self.convt32=nn.Sequential(nn.BatchNorm2d(64,momentum=0.9),
...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.conv3=nn.Sequential(nn.BatchNorm2d(3,momentum=0.9),
                                  nn.Conv2d(3,32,4,2,1),
                                  nn.LeakyReLU()
                                  )
        self.conv32=nn.Sequential(nn.BatchNorm2d(32,momentum=0.9),
                                  nn.Conv2d(32,64,4,2,1),
                                  nn.LeakyReLU()
                                  )
        self.conv64=nn.Sequential(nn.BatchNorm2d(64,momentum=0.9),
                                  nn.Conv2d(64,128,4,2,1),
                                  nn.LeakyReLU()
                                  )
        self.conv128=nn.Sequential(nn.BatchNorm2d(128,momentum=0.9),
                                  nn.Conv2d(128,256,4,2,1),
                                  nn.LeakyReLU()
                                  )
        self.conv256=nn.Sequential(nn.BatchNorm2d(256,momentum=0.9),
