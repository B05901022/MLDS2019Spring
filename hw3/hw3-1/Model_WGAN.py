...
# -*- coding: utf-8 -*-
"""
Created on Mon May 13 10:04:44 2019
...
def main(args):
    ...
    optimizer_g = torch.optim.RMSprop(train_generator.parameters(), **RMSPARAM)#torch.optim.Adam(train_generator.parameters(), **ADAMPARAM)
    optimizer_d = torch.optim.RMSprop(train_discriminator.parameters(), **RMSPARAM)#torch.optim.Adam(train_discriminator.parameters(), **ADAMPARAM2)
    ...
    for e in range(args.epoch):
        ...
        for b_num, (b_x, b_y) in enumerate(train_dataloader):
            ...
            print('batch: ', b_num, '/', total_batch, ' Discriminator Loss: ', -1*(epoch_dloss-old_dloss)/args.k, ' Generator Loss: ', -1*(epoch_gloss-old_gloss), end='\r')
