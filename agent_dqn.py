...
class Agent_DQN(Agent):
    def __init__(self, env, args):
        ...
        if args.test_dqn:
            ...
            """
            self.policy_model=DQN().to(device) #The shape seems (84*84*4), and the models may need to be modified.
    ...
    def make_action(self, observation, test=True):
        ...
        q_value=self.policy_model(toch.Tensor(observation).to(device))s
